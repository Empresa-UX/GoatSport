<?php
/* =========================================================================
 * file: admin/usuarios/proveedoresPendientes.php (NUEVO)
 * Lista de proveedores con estado = pendiente con Aprobar / Denegar
 * ========================================================================= */
...
$sql = "
  ...
  WHERE u.rol='proveedor' AND COALESCE(pd.estado,'pendiente')='pendiente'
...
<div class="section">
  ...
  <style>
    ...
    .col-id{width:30px}.col-nombre{width:135px}.col-email{width:170px}.col-club{width:145px}.col-tel{width:120px}.col-dir{width:145px}.col-ciudad{width:110px}.col-fecha{width:60px}.col-acc{width:90px}
  ...
  <table>
    ...
    <tbody>
      ...
      <?php else: foreach($rows as $r): $reg=ddmm($r['fecha_registro']); ?>
        <tr>
          ...
          <td class="col-acc">
            <div class="actions">
              <form method="POST" action="usuariosAction.php">
                <input type="hidden" name="action" value="approve_proveedor">
                <input type="hidden" name="user_id" value="<?= (int)$r['user_id'] ?>">
                <button type="submit" class="btn-action edit" title="Aprobar">Aprobar</button>
              </form>
              <form method="POST" action="usuariosAction.php" onsubmit="return confirm('¿Denegar este proveedor?');">
                <input type="hidden" name="action" value="deny_proveedor">
                <input type="hidden" name="user_id" value="<?= (int)$r['user_id'] ?>">
